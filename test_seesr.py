...
if __name__ == "__main__":
    ...
    parser.add_argument("--output_dir", type=str, default=r'/root/autodl-tmp/sr/datasets/test/backpage3/predict/')
    ...
    # parser.add_argument("--lora_path",default=r'/root/autodl-tmp/sr/models/output/dreambooth/lora-dreambooth-model8/')
    parser.add_argument("--user_prompt",default='sks backpack')
