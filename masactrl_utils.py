...
def regiter_attention_editor_diffusers(model, editor: AttentionBase):
    ...
    def register_editor(net, count, place_in_unet, total_name=None):
        total_name = total_name if total_name else place_in_unet
        for name, subnet in net.named_children():
            if name == 'image_attentions':
                continue
            if net.__class__.__name__ == 'Attention':  # spatial Transformer layer
                ...
                count = register_editor(subnet, count, place_in_unet, total_name + '_' + name)
        return count
